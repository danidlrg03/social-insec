...
class LoginForm(FlaskForm):
    ...
    username = StringField(
        validators={InputRequired(), Length(max=20)}, label="Username", render_kw={"placeholder": "Username"}
    )
    password = PasswordField(
        validators={InputRequired(), Length(max=20)}, label="Password", render_kw={"placeholder": "Password"}
    )
